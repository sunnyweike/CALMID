...
------rem VarImb_GISGrN10_5 rbf 10/5/5/4/1 G-> Inc 1/2/3/4/5 S->  rbf 5/1/2/2/5->Gradual Recurrent RandomTree 10/5/5/4/1
rem *** RandomTree with Imbalance Ratio 5/4/3/2/1  Gradual Drift-> Incremental Drift ( RandomRBFGeneratorDrift -s 10.0 -k 25 -c 5 -a 21 -n 100) with Imbalance Ratio 1/2/3/4/5 
rem then Incremental Drift with Var Imbalance Ratio 1/2/3/4/5  Sudden Drift ->  Gradual Recurrent Drift between RBF and RandomTree with Var Imbalance Ratio 10/5/5/4/1 

java -cp ..\MOA\moa.jar -javaagent:..\MOA\sizeofag-1.0.0.jar moa.DoTask WriteStreamToARFFFile -s (ConceptDriftStream -s (ImbalancedStream -s (generators.RandomRBFGenerator -c 5 -a 21) -c 0.4;0.2;0.2;0.16;0.04) -d (ConceptDriftStream -s (ImbalancedStream -s (generators.RandomRBFGeneratorDrift -s 25.0 -k 50 -c 5 -a 21 -n 100) -c 0.0667;0.1333;0.2;0.2667;0.3333) -d (ImbalancedStream -s (RecurrentConceptDriftStream -x 20000 -y 30000 -z 4 -s (ImbalancedStream -s (generators.RandomRBFGenerator -r 0 -i 0 -c 5 -a 21) -c 0.3333;0.0668;0.1333;0.1333;0.3333 -i 0) -d (generators.RandomTreeGeneratorIm -r 0 -i 0 -c 5 -o 0 -u 21 -n 10 -p 10 -g 1 -w 1000) -a 0.0099 -w 5000 -r 0) -c 0.4;0.2;0.2;0.16;0.04 -i 0) -p 100000 -w 1) -p 100000 -w 5000) -f .\VarImb_GISGrN10_5.arff -m 400000



----------rem VarImb_GISGrN10_4 rbf 10/5/4/1 G-> Inc 1/2/2/5 S->  rbf 4/1/10/5->Gradual Recurrent RandomTree 10/5/4/1, abbreviation name is VarImb_GISGrN10_4.arff

java -cp ..\MOA\moa.jar -javaagent:..\MOA\sizeofag-1.0.0.jar moa.DoTask WriteStreamToARFFFile -s (ConceptDriftStream -s (ImbalancedStream -s (generators.RandomRBFGenerator -c 4 -a 21) -c 0.5;0.25;0.2;0.05) -d (ConceptDriftStream -s (ImbalancedStream -s (generators.RandomRBFGeneratorDrift -s 25.0 -k 50 -c 4 -a 21 -n 100) -c 0.1;0.2;0.2;0.5) -d (ImbalancedStream -s (RecurrentConceptDriftStream -x 20000 -y 30000 -z 4 -s (ImbalancedStream -s (generators.RandomRBFGenerator -r 0 -i 0 -c 4 -a 21) -c 0.2;0.05;0.5;0.25 -i 0) -d (generators.RandomTreeGeneratorIm -r 0 -i 0 -c 4 -o 0 -u 21 -n 10 -p 10 -g 1 -w 1000) -a 0.0099 -w 5000 -r 0) -c 0.5;0.25;0.2;0.05 -i 0) -p 100000 -w 1) -p 100000 -w 5000) -f .\C4_VarImb_GISGrN10_4.arff -m 400000



----------rem VarImb_GISGrN10 rbf 5/4/1 G-> Inc 1/4/5 S->  rbf 4/1/5->Gradual Recurrent RandomTree 5/4/1, abbreviation name is C3_VarImb_GISGrN10_3.arff

java -cp ..\MOA\moa.jar -javaagent:..\MOA\sizeofag-1.0.0.jar moa.DoTask WriteStreamToARFFFile -s (ConceptDriftStream -s (ImbalancedStream -s (generators.RandomRBFGenerator -c 3 -a 21) -c 0.5;0.4;0.1) -d (ConceptDriftStream -s (ImbalancedStream -s (generators.RandomRBFGeneratorDrift -s 25.0 -k 50 -c 3 -a 21 -n 100) -c 0.1;0.4;0.5) -d (ImbalancedStream -s (RecurrentConceptDriftStream -x 20000 -y 30000 -z 4 -s (ImbalancedStream -s (generators.RandomRBFGenerator -r 0 -i 0 -c 3 -a 21) -c 0.4;0.1;0.5 -i 0) -d (generators.RandomTreeGeneratorIm -r 0 -i 0 -c 3 -o 0 -u 21 -n 10 -p 10 -g 1 -w 1000) -a 0.0099 -w 5000 -r 0) -c 0.5;0.4;0.1 -i 0) -p 100000 -w 1) -p 100000 -w 5000) -f .\C3_VarImb_GISGrN10_3.arff -m 400000
